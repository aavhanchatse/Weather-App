...
class DateUtil {
  ...
  static String getDateFromEpoch(int timestampInSeconds) {
    ...
    return _videoDateFormat.format(date);
  }

  static String getDateAndMonthFromEpoch(int timestampInSeconds) {
    int timestampInMilliseconds = timestampInSeconds * 1000;

    final date = DateTime.fromMillisecondsSinceEpoch(timestampInMilliseconds);
    return _dateMonthDateFormator.format(date);
  }
